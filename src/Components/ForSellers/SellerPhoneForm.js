...
const RegFormPhone = () => {
  ...
  return (
    <div style={{width: window.innerWidth < 1200 ? "85%" : "50%" , margin:"auto"}}>
      <div
        style={{
          width: "25%",
      ...
      >
        THOUSANDS OF BUYERS, AUCTIONS FOR EVERY TYPE OF MOBILE DEVICE
      </div>
      <div
        style={{
      ...
      >
        ...
        serve your business. Please complete the fields below to connect with a
        member of our team.
      </div>
      <div
        style={{
